...
export const Deposit = ({ userType, transaction, transactionContent, id }) => {
  ...
  const HandleUploadProofOfFunds = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://nutlip-backend.onrender.comapi/transaction/transaction_proofoffunds10_08", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleConfirm = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch("https://nutlip-backend.onrender.comapi/transaction/transaction_confirmproofoffunds_09", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
...
export const DOC = ({ transaction, id, userType, transactionContent }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://nutlip-backend.onrender.comapi/transaction/transaction_setdate_010`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleConfirm = async (e) => {
    ...
    try {
      const response = await fetch(`https://nutlip-backend.onrender.comapi/transaction/transaction_confirmdate_011`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
