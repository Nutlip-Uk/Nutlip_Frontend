...
export const FullPayment = ({ userType, transaction, transactionContent, id }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch("aws url for now, http://ec2-13-60-41-27.eu-north-1.compute.amazonaws.comapi/transaction/transaction_proofoffunds90_012", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const handleConfirm = async () => {
        try {
            const response = await fetch("aws url for now, http://ec2-13-60-41-27.eu-north-1.compute.amazonaws.comapi/transaction/transaction_confirmproofoffunds90_013", {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
