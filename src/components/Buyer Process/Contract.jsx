...
export const Contract = ({ userType, transaction, id, transactionContent }) => {
    ...
    const HandleSubmitSeller = async () => {
        try {
            const response = await fetch(`https://nutlip-backend-wdsi.onrender.com/api/transaction/transaction_contractupload_06_seller`, {
                method: "PUT",
                headers: {
    ...
    const HandleSubmitBuyer = async () => {
        try {
            const response = await fetch(`https://nutlip-backend-wdsi.onrender.com/api/transaction/transaction_contractupload_06_buyer`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const HandleConfirm = async () => {
        try {
            const response = await fetch(`https://nutlip-backend-wdsi.onrender.com/api/transaction/transaction_contractupload_06_seller_confirms`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
