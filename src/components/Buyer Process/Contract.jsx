...
export const Contract = ({ userType, transaction, id, transactionContent }) => {
    ...
    const HandleSubmitSeller = async () => {
        try {
            const response = await fetch(`aws url for now, http://ec2-13-60-41-27.eu-north-1.compute.amazonaws.comapi/transaction/transaction_contractupload_06_seller`, {
                method: "PUT",
                headers: {
    ...
    const HandleSubmitBuyer = async () => {
        try {
            const response = await fetch(`aws url for now, http://ec2-13-60-41-27.eu-north-1.compute.amazonaws.comapi/transaction/transaction_contractupload_06_buyer`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const HandleConfirm = async () => {
        try {
            const response = await fetch(`aws url for now, http://ec2-13-60-41-27.eu-north-1.compute.amazonaws.comapi/transaction/transaction_contractupload_06_seller_confirms`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
