...
export const TransferTitle = ({ userType, transaction, transactionContent, id }) => {
    ...
    const handleSubmitSeller = async () => {
        try {
            const response = await fetch(`https://nutlip-backend-wdsi.onrender.com/api/transaction/transaction_legalTitle_014`, {
                method: "PUT",
                headers: {
    ...
    const handleSubmitBuyer = async () => {
        ...
        try {
            const response = await fetch(`https://nutlip-backend-wdsi.onrender.com/api/transaction/transaction_legalTitle_015`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
