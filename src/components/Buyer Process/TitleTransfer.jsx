...
export const TransferTitle = ({ userType, transaction, transactionContent, id }) => {
    ...
    const handleSubmitSeller = async () => {
        try {
            const response = await fetch(`aws url for now, http://ec2-13-60-41-27.eu-north-1.compute.amazonaws.comapi/transaction/transaction_legalTitle_014`, {
                method: "PUT",
                headers: {
    ...
    const handleSubmitBuyer = async () => {
        ...
        try {
            const response = await fetch(`aws url for now, http://ec2-13-60-41-27.eu-north-1.compute.amazonaws.comapi/transaction/transaction_legalTitle_015`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
