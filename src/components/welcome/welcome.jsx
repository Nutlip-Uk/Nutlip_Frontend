    ...
    <div className={styles.Section}>
      <div className={styles.container}>
        ...
        <div className={styles.box}>
          ...
          {count.current === 3 && selectedRole === "guest" && (
            <Guest
              next={next}
              back={back}
              form={form}
          ...
          <div className={styles.form2}>
            ...
            <div>
              ...
              <input
                ...
                id="fullname"
                name="fullname"
                value={userInformation.user.name}
                placeHolder={userInformation.user.name}
                disabled
              />
            </div>
            <div>
      ...
      <div className={styles.welcomeContainer}>
        <div className={styles.congratulationsContainer}>
          ...
          <p className={styles.Thankyou}>
            {"Thank you for completing the forms. Enjoy the Nutlip platform."}
          </p>
