          ...
          <section className={styles.rowOne}>
            <section className={styles.Price}>
              ...
              <div className={styles.PriceSelectContainer}>
                <select name="minBedRoom" value={filters.minBedRoom} onChange={handleOnChange}>
                  <option value="0">Min</option>
                  {/* Add more options as needed */}
                </select>
                <select name="maxBedRoom" value={filters.maxBedRoom} onChange={handleOnChange}>
            ...
            <section className={styles.Price}>
              <h4>Price range</h4>
              <div className={styles.PriceSelectContainer}>
                <select name="minPrice" value={filters.minPrice} onChange={handleOnChange}>
                  <option value="0">Min</option>
                  {/* Add more options as needed */}
                </select>
                <select name="maxPrice" value={filters.maxPrice} onChange={handleOnChange}>
                  <option value="0">Max</option>
                  {/* Add more options as needed */}
                </select>
              </div>
