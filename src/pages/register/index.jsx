...
const Registration = () => {
  ...
  const handleGoogleSignUp = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://nutlip-backend-wdsi.onrender.com/api/register", {
        method: "POST",
        headers: {
  ...
  const handleGoogleSignIn = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://nutlip-backend-wdsi.onrender.com/api/login", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleFacebookAuth = async (e) => {
    ...
    try {
      ...
      const loginResponse = await fetch("https://nutlip-backend-wdsi.onrender.com/api/login", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      if (loginResponse.ok) {
        ...
        const registerResponse = await fetch("https://nutlip-backend-wdsi.onrender.com/api/register", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
