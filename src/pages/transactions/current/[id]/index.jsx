  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const transactionResponse = await fetch(`https://nutlip-backend-yhfz.onrender.com/api/transaction/gettransaction/${id}`);
        ...
        if (transactionResponse.ok) {
          ...
          const txcontent = await fetch(`https://nutlip-backend-yhfz.onrender.com/api/transaction/gettransactioncontent/${id}`);
          ...
          const apartmentResponse = await fetch(`https://nutlip-backend-yhfz.onrender.com/api/apartments/getapartment/${transactionData.transaction.ApartmentId}`);
          ...
          const sellerResponse = await fetch(`https://nutlip-backend-yhfz.onrender.com/api/users/${userInformation?.user?.id}`);
          const sellerData = await sellerResponse.json();
          setSellerInfo(sellerData.data);
          console.log("seller data", sellerInfo);

          // Fetch agent data using apartment data
          const agentResponse = await fetch(`https://nutlip-backend-yhfz.onrender.com/api/users/${apartmentData.data.userId}`);
