  ...
  return (
    <section className={styles.Section}>
      <div className={styles.container}>
        ...
        <DetailsImages viewOptions={viewOptions} setViewOptions={setViewOptions}  data={property} />
        <div className={styles.detailContainer}>
          <DetailsContent  viewOptions={viewOptions} setViewOptions={setViewOptions} data={property} handleShow={openModal} />
